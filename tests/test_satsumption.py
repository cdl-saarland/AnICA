...
from anica.satsumption import check_subsumed, check_subsumed_aa, check_subsumed_arbitrary_order, check_subsumed_aa_arbitrary_order
...
def test_satsumption_aa_fixed_order_01(random, actx):
    ...
    assert check_subsumed_aa_arbitrary_order(ab1, ab2)
    assert not check_subsumed_aa(ab1, ab2)

def test_satsumption_aa_fixed_order_02(random, actx):
...
def test_satsumption_aa_fixed_order_03(random, actx):
...
def test_satsumption_aa_fixed_order_04(random, actx):
...
def test_satsumption_aa_fixed_order_05(random, actx):
    ...
    assert not check_subsumed_aa_arbitrary_order(ab1, ab2)
    assert not check_subsumed_aa(ab1, ab2)

def test_satsumption_aa_fixed_order_06(random, actx):
...
def test_satsumption_aa_fixed_order_07(random, actx):
...
def test_satsumption_aa_fixed_order_08(random, actx):
